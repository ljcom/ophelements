...
function refreshTalk(guid, comment, location, f) {
    ...
    if (location == '10') {
        ...
        xsldoc = 'OPHContent/themes/' + loadThemeFolder() + '/xslt/_browse_talk.xslt';
    }
    else {
        xsldoc = 'OPHContent/themes/' + loadThemeFolder() + '/xslt/_form_talk.xslt';
    }
    ...
    setTimeout(function () { refreshTalk(getGUID(), '', location); }, 1000 * 60);
    //e.srcElement.focus();
}
